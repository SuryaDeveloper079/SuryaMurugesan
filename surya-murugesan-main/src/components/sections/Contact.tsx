...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="bg-gradient-to-br from-blue-50/70 to-indigo-100/70 relative overflow-hidden backdrop-blur-sm"
    >
              ...
              <div className="space-y-6">
                <div className="flex items-center group hover:transform hover:translate-x-2 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:suryadeveloper079@gmail.com"
                      className="text-lg font-semibold hover:text-primary transition-colors"
                    >
                      suryadeveloper079@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center group hover:transform hover:translate-x-2 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <a
                      href="https://linkedin.com/in/surya-murugesan-72a86b208"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-lg font-semibold hover:text-primary transition-colors"
                    >
                      linkedin.com/in/surya-murugesan
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center group hover:transform hover:translate-x-2 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <a
                      href="https://github.com/SuryaDeveloper079"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-lg font-semibold hover:text-primary transition-colors"
                    >
                      github.com/SuryaDeveloper079
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      Sivakasi, Tamil Nadu, India - 626131
                    </p>
                  </div>
                </div>
